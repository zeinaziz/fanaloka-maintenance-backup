...
define( 'FM_VERSION', '1.0.5' );
define( 'FM_GITHUB_REPO', 'zeinaziz/fanaloka-maintenance-backup' );
...
final class Plugin {
    ...
    private function init_hooks(): void {
        ...
        if ( is_admin() ) {
            ( new \Fanaloka\Maintenance\Updater\GitHubUpdater( __FILE__, FM_GITHUB_REPO, FM_VERSION ) )->init();
        }
    }
